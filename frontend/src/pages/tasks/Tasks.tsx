                ...
                <AnimatePresence>
                  {showFilterMenu && (
                    <motion.div
                      ...
                      className="absolute top-full right-0 mt-2 w-64 bg-[#2A2A2A]/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-4 z-50"
                    >
                      <div className="mb-4">
                        <p className="text-xs text-gray-400 mb-2 font-semibold uppercase">Status</p>
                      ...
                      <div className="border-t border-white/10 pt-4">
                        <p className="text-xs text-gray-400 mb-2 font-semibold uppercase">Priority</p>
                        <div className="flex flex-col gap-2">
                ...
                <AnimatePresence>
                  {showSortMenu && (
                    <motion.div
                      ...
                      className="absolute top-full right-0 mt-2 w-64 bg-[#2A2A2A]/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-4 z-50"
                    >
                      <p className="text-xs text-gray-400 mb-2 font-semibold uppercase">Sort By</p>
                      {([
                      ...
                      <div className="border-t border-white/10 pt-4 mt-2">
                        <p className="text-xs text-gray-400 mb-2 font-semibold uppercase">Order</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4 mb-2">
                        ...
                        {/* Priority Badge */}
                        <span className={`flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium border whitespace-nowrap ${getPriorityColor(task.priority)}`}>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium border ${getPriorityColor(selectedTask.priority)}`}>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        <option value="todo" className="bg-[#2A2A2A] text-white">To Do</option>
                        <option value="in_progress" className="bg-[#2A2A2A] text-white">In Progress</option>
                        <option value="completed" className="bg-[#2A2A2A] text-white">Completed</option>
                        <option value="cancelled" className="bg-[#2A2A2A] text-white">Cancelled</option>
                      </select>
                    </div>
                  </div>
                  ...
                  {selectedTask.due_date && (
                    <div>
                      <h3 className="text-sm font-semibold text-gray-400 mb-2 uppercase">Due Date</h3>
                      <div className={`px-4 py-2 bg-white/5 border border-white/10 rounded-lg ${selectedTask.is_overdue ? 'text-red-400' : 'text-white'}`}>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-400 mb-1 uppercase">Created</h3>
                    <p className="text-white">{new Date(selectedTask.created_at).toLocaleString()}</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold text-gray-400 mb-1 uppercase">Updated</h3>
                    <p className="text-white">{new Date(selectedTask.updated_at).toLocaleString()}</p>
                  </div>
                </div>
